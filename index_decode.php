<?php
	...
	if ( !empty($dna_code) ) {
		$ascii_string = $dna_convert->get_text($dna_code);
		$fm_string = $dna_convert->get_formatted_dna($dna_code);

	}
	if ( empty($ascii_string) ) $ascii_string = "Your text will appear here";
?>
<!DOCTYPE HTML>
<html lang="en-US">
<head>
...
<div id="dna-converter-container">
	...
	<div id="dna-converter-help-content">
		...
		<p>
			This tool converts dna-encoded string to text.<br>
	...
	<h5>Your Text:</h5>
	<div id="dna-code-response"><?php echo $ascii_string; ?></div>

	<form action="" method="POST">
        <textarea name="dna-string" placeholder="Enter your DNA code here"><?php echo str_replace(" ", "", trim($dna_code)); ?></textarea>
